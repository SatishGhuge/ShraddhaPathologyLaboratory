...
const Header = () => {
  ...
  const [videoModal,   setVideoModal]   = useState(null); // holds embed URL
  const [comingSoon,   setComingSoon]   = useState(null); // holds feature name
