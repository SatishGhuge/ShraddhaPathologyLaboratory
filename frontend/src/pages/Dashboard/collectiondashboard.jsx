    ...
    <div className="flex h-screen bg-gradient-to-br from-cyan-50 to-blue-50 overflow-hidden">
      ...
      `}>
        ...
        <div className="p-4 border-b border-white/20">
          <div className="flex items-center gap-3 mb-2 cursor-pointer hover:opacity-80 transition-opacity" onClick={() => navigate("/labdashboard")}>
      ...
      <div className="flex-1 overflow-y-auto w-full lg:w-auto">
        <div className="p-4 sm:p-6 space-y-4 sm:space-y-6 mt-16 lg:mt-0">
          ...
          {activeMenu === "reports" ? (
            ...
            /* PATIENT REGISTRATION CONTENT - Full Component Embedded */
            <div className="w-full">
              <PatientRegistration hideHeader={true} />
            </div>
          ) : activeMenu === "samples" ? (
