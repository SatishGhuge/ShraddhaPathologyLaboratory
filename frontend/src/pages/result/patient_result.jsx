...
import { getPatientTestById } from "../../api/result.js";
import { updateTestStatus } from "../../api/result.js";
...
const PatientResult = () => {
  ...
  const [attachedFileUrl, setAttachedFileUrl] = useState(null); // object URL for preview/print
  ...
  const isValueOutOfRange = (param, numericValue) => {
  ...
  const handleAbnormalChange = (parameterId) => {
      ...
      <div className="p-4 bg-gray-100 min-h-screen">
        ...
        <div className="mt-3 bg-white border">
          <table className="w-full text-sm border-collapse">
            ...
            <tbody>
              {Object.entries(groupedParameters).map(([categoryName, categoryParams]) => (
          ...
          <div className="flex flex-wrap gap-2 p-3">
            ...
            <button onClick={() => navigate(-1)} className="bg-gray-500 text-white px-3 py-1 rounded text-sm">Back</button>
            ...
            <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[95vh] flex flex-col">
              ...
              <div className="overflow-y-auto flex-1">
                ...
                {(attachedFileUrl || patientData.attachmentPath) && (() => {
                  const src = attachedFileUrl || `${import.meta.env.VITE_API_URL.replace('/api','')}${patientData.attachmentPath}`;
