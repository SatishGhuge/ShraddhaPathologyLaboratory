...
import img_department from "../../assets/img-department.png";
...
const AddDepartment = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      let response;
      if (isAddMode) {
        response = await fetch(`${import.meta.env.VITE_API_URL}/master/departments`, {
          method: 'POST',
          headers: {
        ...
        response = await fetch(`${import.meta.env.VITE_API_URL}/master/departments/${id}`, {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json'
          },
      ...
      if (result.success) {
        ...
        setTimeout(() => {
          ...
          navigate("/master/departmentlist");
        }, 2000);
      } else {
