...
import { getRoleById, createRole, updateRole } from "../../api/master.js";
...
const AddRole = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess(true);
      setTimeout(() => navigate("/master/rolelist"), 1500);
    } catch (err) {
        ...
        <div className="bg-white border border-gray-200 rounded-lg shadow-md p-4 max-w-xl w-full">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-between items-center border-b border-gray-300 pb-2">
              ...
              <button type="button" onClick={() => navigate("/master/rolelist")} className="hover:bg-cyan-100 p-1 rounded">
                <ArrowLeft size={20} />
              </button>
            </div>
