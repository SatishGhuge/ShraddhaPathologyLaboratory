...
import { getUserById, createUser, updateUser } from "../../api/master.js";
import { getRoles, getCollectionCenters } from "../../api/master.js";
...
export default function AddUserForm() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setTimeout(() => navigate("/master/userlist"), 1500);
    } catch (err) {
      ...
      <div className="p-6 bg-cyan-50 min-h-screen flex justify-center">
        <div className="w-[500px] bg-white p-4 rounded-lg shadow-lg border border-gray-200 h-fit">
          ...
          <div className="flex justify-between items-center border-b border-cyan-600 pb-2 mb-4">
            ...
            <button onClick={() => navigate("/master/userlist")} className="text-cyan-700 hover:text-cyan-900">
              <ArrowLeft size={24} />
            </button>
          </div>
          ...
          <div className="flex justify-center gap-3 mt-4">
            ...
            <button onClick={() => navigate("/master/userlist")} className="bg-gray-500 hover:bg-gray-600 text-white px-5 py-1.5 text-sm rounded-md">
              Cancel
            </button>
          </div>
