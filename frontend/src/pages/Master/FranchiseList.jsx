...
import { getFranchises, deleteFranchise } from "../../api/master.js";
...
const FranchiseList = () => {
  ...
  useEffect(() => {
    getFranchises()
      .then(data => { setFranchises(data); setFilteredFranchises(data); })
      .catch(console.error);
  }, []);
    ...
    <>
      ...
      <div className="p-6 bg-cyan-50 min-h-screen">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 mb-4 bg-white p-3 rounded shadow-md">
          ...
          <button
            onClick={() => navigate("/master/franchise/add")}
                  ...
                  <tr key={f.id} className="hover:bg-gray-50 border-b border-gray-200">
                    ...
                    <td className="border border-gray-300 px-3 py-1">
                      <div className="flex gap-1 flex-wrap">
                        {/* VIEW */}
                        <button
                          onClick={() => navigate(`/master/franchise/view/${f.id}`)}
                        ...
                        {/* EDIT */}
                        <button
                          onClick={() => navigate(`/master/franchise/edit/${f.id}`)}
