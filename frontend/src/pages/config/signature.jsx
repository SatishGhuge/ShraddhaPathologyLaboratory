...
const empty = {
  specialty: '', doctorName: '', signatureText: '', signatureImage: null,
            ...
            <div className="px-5 py-4 space-y-3 text-sm">
              {[
                ...
                <div key={f.name} className="grid grid-cols-3 gap-3 items-center">
                  ...
                  {f.type === 'select' ? (
                    <select name={f.name} value={formData[f.name]} onChange={e => setFormData(p => ({ ...p, [f.name]: e.target.value }))}
                    ...
                    <input type="text" name={f.name} value={formData[f.name]} onChange={e => setFormData(p => ({ ...p, [f.name]: e.target.value }))}
                      className="col-span-2 border border-gray-300 rounded px-2 py-1.5 focus:ring-1 focus:ring-cyan-500 outline-none" />
                  )}
                </div>
              ))}
              ...
              <div className="grid grid-cols-3 gap-3 items-center">
                ...
                <select value={formData.isActive} onChange={e => setFormData(p => ({ ...p, isActive: e.target.value === 'true' }))}
                  className="col-span-2 border border-gray-300 rounded px-2 py-1.5 focus:ring-1 focus:ring-cyan-500 outline-none">
