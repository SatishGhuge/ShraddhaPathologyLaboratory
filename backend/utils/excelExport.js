...
export const exportTestsToExcel = async () => {
  try {
    ...
    parametersSheet.columns = [
      ...
      { header: 'Text Content', key: 'textContent', width: 25 },
      { header: 'Male Display Text', key: 'maleDisplayText', width: 25 },
      { header: 'Female Display Text', key: 'femaleDisplayText', width: 25 },
      { header: 'Default Display Text', key: 'defaultDisplayText', width: 25 },
      { header: 'Is Multiple Options', key: 'isMultipleOptions', width: 15 },
      { header: 'Display Range Text', key: 'displayRangeText', width: 30 },
      { header: 'Range Text', key: 'rangeText', width: 30 },
      { header: 'Is NABL', key: 'isNABL', width: 10 },
      { header: 'Is Active', key: 'isActive', width: 10 },
    ...
    tests.forEach(test => {
      test.ownedParameters?.forEach(param => {
        parametersSheet.addRow({
          ...
          isMultipleOptions: param.isMultipleOptions ? 'Yes' : 'No',
