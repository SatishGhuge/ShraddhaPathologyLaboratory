...
const DEFAULT_FIELDS = [
  // Patient Information
  { fieldKey: "patient_name", fieldLabel: "Patient Name", isVisible: true, isBold: true, isItalic: false, isUnderline: false, displayOrder: 1, sectionName: "Patient Information" },
  ...
  { fieldKey: "patient_uid", fieldLabel: "Patient ID", isVisible: true, isBold: false, isItalic: false, isUnderline: false, displayOrder: 4, sectionName: "Patient Information" },
  { fieldKey: "registration_no", fieldLabel: "Registration No.", isVisible: false, isBold: false, isItalic: false, isUnderline: false, displayOrder: 5, sectionName: "Patient Information" },

  // Report Details
  { fieldKey: "referred_doctor", fieldLabel: "Referred By", isVisible: true, isBold: false, isItalic: false, isUnderline: false, displayOrder: 6, sectionName: "Report Details" },
  { fieldKey: "organization_name", fieldLabel: "Lab/Organization", isVisible: true, isBold: true, isItalic: false, isUnderline: false, displayOrder: 7, sectionName: "Report Details" },
  { fieldKey: "organization_location", fieldLabel: "Location", isVisible: true, isBold: false, isItalic: false, isUnderline: false, displayOrder: 8, sectionName: "Report Details" },
  { fieldKey: "report_date", fieldLabel: "Report Date", isVisible: true, isBold: false, isItalic: false, isUnderline: false, displayOrder: 9, sectionName: "Report Details" },
  { fieldKey: "authorized_by", fieldLabel: "Authorized By", isVisible: true, isBold: false, isItalic: false, isUnderline: false, displayOrder: 10, sectionName: "Report Details" },

  // System Fields
  { fieldKey: "qr_code", fieldLabel: "QR Code", isVisible: true, isBold: false, isItalic: false, isUnderline: false, displayOrder: 11, sectionName: "System Fields" },
  { fieldKey: "print_date", fieldLabel: "Print Date", isVisible: true, isBold: false, isItalic: false, isUnderline: false, displayOrder: 12, sectionName: "System Fields" },
  { fieldKey: "mobile", fieldLabel: "Mobile", isVisible: false, isBold: false, isItalic: false, isUnderline: false, displayOrder: 13, sectionName: "System Fields" },
  { fieldKey: "email", fieldLabel: "Email", isVisible: false, isBold: false, isItalic: false, isUnderline: false, displayOrder: 14, sectionName: "System Fields" },
  { fieldKey: "address", fieldLabel: "Address", isVisible: false, isBold: false, isItalic: false, isUnderline: false, displayOrder: 15, sectionName: "System Fields" },
];
...
const DEFAULT_FORMATTING = {
  ...
  fontSizeBody: 11,
  fontSizeFooter: 9,
  fontSizeSignature: 80,
  lineHeight: 1.4,
  paperSize: "A4",
  paperMargin: 40,
  verticalSpacing: "Compressed",
  dateFormat: "01 Dec. 2015, 12:00 a.m.",
  minApproval: 1,
  maxApproval: 2,
